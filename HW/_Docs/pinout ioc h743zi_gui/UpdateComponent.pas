...
var
    ...
    NewPartArr   : array[1..19] of ISch_Component;
    R            : ISch_Rectangle;
...
// OR //
    ...
    TextObj.Text := 'part ' + '1' + ': ' + 'ADC1';  // Set text content
    ...
    PinArr[47].Name := 'ADC1_INP5';
    PinArr[47].OwnerPartId := 1;
    PinArr[47].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    PinArr[46].Name := 'ADC1_INP9';
    PinArr[46].OwnerPartId := 1;
    PinArr[46].Location := Point(MilsToCoord(0), MilsToCoord(-200));
    ...
    PinArr[27].Name := 'ADC1_INP11';
    PinArr[27].OwnerPartId := 1;
    PinArr[27].Location := Point(MilsToCoord(0), MilsToCoord(-300));
    ...
    PinArr[37].Name := 'ADC1_INP15';
    PinArr[37].OwnerPartId := 1;
    PinArr[37].Location := Point(MilsToCoord(0), MilsToCoord(-400));
    ...
    PinArr[40].Name := 'ADC1_INP18';
    PinArr[40].OwnerPartId := 1;
    PinArr[40].Location := Point(MilsToCoord(0), MilsToCoord(-500));
    ...
    PinArr[41].Name := 'ADC1_INP19';
    PinArr[41].OwnerPartId := 1;
    PinArr[41].Location := Point(MilsToCoord(0), MilsToCoord(-600));
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '2' + ': ' + 'DEBUG';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    R.LineWidth := eSmall;
    R.Location  := Point(MilsToCoord(0), MilsToCoord(0));
    R.Corner    := Point(MilsToCoord(2000), MilsToCoord(-100*(46+1)));
    R.Color     := $000080;    // Maroon
    R.AreaColor := $B0FFFF;    // Portafino
    R.IsSolid   := True;
    R.OwnerPartId          := 3;
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '3' + ': ' + 'FMC';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    PinArr[4].Name := 'FMC_A21';
    PinArr[4].OwnerPartId := 3;
    PinArr[4].Location := Point(MilsToCoord(0), MilsToCoord(-1300));
    ...
    PinArr[5].Name := 'FMC_A22';
    PinArr[5].OwnerPartId := 3;
    PinArr[5].Location := Point(MilsToCoord(0), MilsToCoord(-1400));
    ...
    PinArr[89].OwnerPartId := 3;
    PinArr[89].Location := Point(MilsToCoord(0), MilsToCoord(-1500));
    ...
    PinArr[90].OwnerPartId := 3;
    PinArr[90].Location := Point(MilsToCoord(0), MilsToCoord(-1600));
    ...
    PinArr[85].OwnerPartId := 3;
    PinArr[85].Location := Point(MilsToCoord(0), MilsToCoord(-1700));
    ...
    PinArr[86].OwnerPartId := 3;
    PinArr[86].Location := Point(MilsToCoord(0), MilsToCoord(-1800));
    ...
    PinArr[114].OwnerPartId := 3;
    PinArr[114].Location := Point(MilsToCoord(0), MilsToCoord(-1900));
    ...
    PinArr[115].OwnerPartId := 3;
    PinArr[115].Location := Point(MilsToCoord(0), MilsToCoord(-2000));
    ...
    PinArr[58].OwnerPartId := 3;
    PinArr[58].Location := Point(MilsToCoord(0), MilsToCoord(-2100));
    ...
    PinArr[59].OwnerPartId := 3;
    PinArr[59].Location := Point(MilsToCoord(0), MilsToCoord(-2200));
    ...
    PinArr[60].OwnerPartId := 3;
    PinArr[60].Location := Point(MilsToCoord(0), MilsToCoord(-2300));
    ...
    PinArr[63].OwnerPartId := 3;
    PinArr[63].Location := Point(MilsToCoord(0), MilsToCoord(-2400));
    ...
    PinArr[64].OwnerPartId := 3;
    PinArr[64].Location := Point(MilsToCoord(0), MilsToCoord(-2500));
    ...
    PinArr[65].OwnerPartId := 3;
    PinArr[65].Location := Point(MilsToCoord(0), MilsToCoord(-2600));
    ...
    PinArr[66].OwnerPartId := 3;
    PinArr[66].Location := Point(MilsToCoord(0), MilsToCoord(-2700));
    ...
    PinArr[67].OwnerPartId := 3;
    PinArr[67].Location := Point(MilsToCoord(0), MilsToCoord(-2800));
    ...
    PinArr[68].OwnerPartId := 3;
    PinArr[68].Location := Point(MilsToCoord(0), MilsToCoord(-2900));
    ...
    PinArr[77].OwnerPartId := 3;
    PinArr[77].Location := Point(MilsToCoord(0), MilsToCoord(-3000));
    ...
    PinArr[78].OwnerPartId := 3;
    PinArr[78].Location := Point(MilsToCoord(0), MilsToCoord(-3100));
    ...
    PinArr[79].OwnerPartId := 3;
    PinArr[79].Location := Point(MilsToCoord(0), MilsToCoord(-3200));
    ...
    PinArr[141].OwnerPartId := 3;
    PinArr[141].Location := Point(MilsToCoord(0), MilsToCoord(-3300));
    ...
    PinArr[142].OwnerPartId := 3;
    PinArr[142].Location := Point(MilsToCoord(0), MilsToCoord(-3400));
    ...
    PinArr[97].Name := 'FMC_NE1';
    PinArr[97].OwnerPartId := 3;
    PinArr[97].Location := Point(MilsToCoord(0), MilsToCoord(-3500));
    ...
    PinArr[127].Name := 'FMC_NE4';
    PinArr[127].OwnerPartId := 3;
    PinArr[127].Location := Point(MilsToCoord(0), MilsToCoord(-3600));
    ...
    PinArr[118].Name := 'FMC_NOE';
    PinArr[118].OwnerPartId := 3;
    PinArr[118].Location := Point(MilsToCoord(0), MilsToCoord(-3700));
    ...
    PinArr[119].Name := 'FMC_NWE';
    PinArr[119].OwnerPartId := 3;
    PinArr[119].Location := Point(MilsToCoord(0), MilsToCoord(-3800));
    ...
    PinArr[29].OwnerPartId := 3;
    PinArr[29].Location := Point(MilsToCoord(0), MilsToCoord(-3900));
    ...
    PinArr[135].OwnerPartId := 3;
    PinArr[135].Location := Point(MilsToCoord(0), MilsToCoord(-4000));
    ...
    PinArr[93].OwnerPartId := 3;
    PinArr[93].Location := Point(MilsToCoord(0), MilsToCoord(-4100));
    ...
    PinArr[132].OwnerPartId := 3;
    PinArr[132].Location := Point(MilsToCoord(0), MilsToCoord(-4200));
    ...
    PinArr[28].OwnerPartId := 3;
    PinArr[28].Location := Point(MilsToCoord(0), MilsToCoord(-4300));
    ...
    PinArr[136].OwnerPartId := 3;
    PinArr[136].Location := Point(MilsToCoord(0), MilsToCoord(-4400));
    ...
    PinArr[49].OwnerPartId := 3;
    PinArr[49].Location := Point(MilsToCoord(0), MilsToCoord(-4500));
    ...
    PinArr[26].Name := 'FMC_SDNWE';
    PinArr[26].OwnerPartId := 3;
    PinArr[26].Location := Point(MilsToCoord(0), MilsToCoord(-4600));
    ...
    R.LineWidth := eSmall;
    R.Location  := Point(MilsToCoord(0), MilsToCoord(0));
    R.Corner    := Point(MilsToCoord(2000), MilsToCoord(-100*(8+1)));
    R.Color     := $000080;    // Maroon
    R.AreaColor := $B0FFFF;    // Portafino
    R.IsSolid   := True;
    R.OwnerPartId          := 4;
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '4' + ': ' + 'GPIO';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    PinArr[42].Name := 'GPIO_Input';
    PinArr[42].OwnerPartId := 4;
    PinArr[42].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    PinArr[43].Name := 'GPIO_Input';
    PinArr[43].OwnerPartId := 4;
    PinArr[43].Location := Point(MilsToCoord(0), MilsToCoord(-200));
    ...
    PinArr[44].Name := 'GPIO_Input';
    PinArr[44].OwnerPartId := 4;
    PinArr[44].Location := Point(MilsToCoord(0), MilsToCoord(-300));
    ...
    PinArr[45].Name := 'GPIO_Input';
    PinArr[45].OwnerPartId := 4;
    PinArr[45].Location := Point(MilsToCoord(0), MilsToCoord(-400));
    ...
    PinArr[102].Name := 'GPIO_Input';
    PinArr[102].OwnerPartId := 4;
    PinArr[102].Location := Point(MilsToCoord(0), MilsToCoord(-500));
    ...
    PinArr[7].OwnerPartId := 4;
    PinArr[7].Location := Point(MilsToCoord(0), MilsToCoord(-600));
    ...
    PinArr[48].Name := 'GPIO_Output';
    PinArr[48].OwnerPartId := 4;
    PinArr[48].Location := Point(MilsToCoord(0), MilsToCoord(-700));
    ...
    PinArr[96].Name := 'GPIO_Output';
    PinArr[96].OwnerPartId := 4;
    PinArr[96].Location := Point(MilsToCoord(0), MilsToCoord(-800));
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '5' + ': ' + 'GROUND';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '6' + ': ' + 'I2C1';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '7' + ': ' + 'I2C2';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    PinArr[69].Name := 'I2C2_SCL';
    PinArr[69].OwnerPartId := 7;
    PinArr[69].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    PinArr[70].Name := 'I2C2_SDA';
    PinArr[70].OwnerPartId := 7;
    PinArr[70].Location := Point(MilsToCoord(0), MilsToCoord(-200));
    ...
    // Add pins to this part
    // Pin '80', 'QUADSPI_BK1_IO0'
    PinArr[80] := SchServer.SchObjectFactory(ePin, eCreate_Default);
    If PinArr[80] = Nil Then Exit;
    PinArr[80].Designator := '80';
    PinArr[80].Name := 'QUADSPI_BK1_IO0';
    PinArr[80].OwnerPartId := 10;
    PinArr[80].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    // Pin '81', 'QUADSPI_BK1_IO1'
    PinArr[81] := SchServer.SchObjectFactory(ePin, eCreate_Default);
    If PinArr[81] = Nil Then Exit;
    PinArr[81].Designator := '81';
    PinArr[81].Name := 'QUADSPI_BK1_IO1';
    PinArr[81].OwnerPartId := 10;
    PinArr[81].Location := Point(MilsToCoord(0), MilsToCoord(-200));
    ...
    // Pin '1', 'QUADSPI_BK1_IO2'
    PinArr[1] := SchServer.SchObjectFactory(ePin, eCreate_Default);
    If PinArr[1] = Nil Then Exit;
    PinArr[1].Designator := '1';
    PinArr[1].Name := 'QUADSPI_BK1_IO2';
    PinArr[1].OwnerPartId := 10;
    PinArr[1].Location := Point(MilsToCoord(0), MilsToCoord(-300));
    ...
    // Pin '82', 'QUADSPI_BK1_IO3'
    PinArr[82] := SchServer.SchObjectFactory(ePin, eCreate_Default);
    If PinArr[82] = Nil Then Exit;
    PinArr[82].Designator := '82';
    PinArr[82].Name := 'QUADSPI_BK1_IO3';
    PinArr[82].OwnerPartId := 10;
    PinArr[82].Location := Point(MilsToCoord(0), MilsToCoord(-400));
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '11' + ': ' + 'RCC';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    PinArr[23].Name := 'RCC_OSC_IN';
    PinArr[23].OwnerPartId := 11;
    PinArr[23].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    PinArr[24].Name := 'RCC_OSC_OUT';
    PinArr[24].OwnerPartId := 11;
    PinArr[24].Location := Point(MilsToCoord(0), MilsToCoord(-200));
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '12' + ': ' + 'SDMMC1';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    PinArr[113].Name := 'SDMMC1_CK';
    PinArr[113].OwnerPartId := 12;
    PinArr[113].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    PinArr[116].Name := 'SDMMC1_CMD';
    PinArr[116].OwnerPartId := 12;
    PinArr[116].Location := Point(MilsToCoord(0), MilsToCoord(-200));
    ...
    PinArr[98].Name := 'SDMMC1_D0';
    PinArr[98].OwnerPartId := 12;
    PinArr[98].Location := Point(MilsToCoord(0), MilsToCoord(-300));
    ...
    PinArr[99].Name := 'SDMMC1_D1';
    PinArr[99].OwnerPartId := 12;
    PinArr[99].Location := Point(MilsToCoord(0), MilsToCoord(-400));
    ...
    PinArr[111].Name := 'SDMMC1_D2';
    PinArr[111].OwnerPartId := 12;
    PinArr[111].Location := Point(MilsToCoord(0), MilsToCoord(-500));
    ...
    PinArr[112].Name := 'SDMMC1_D3';
    PinArr[112].OwnerPartId := 12;
    PinArr[112].Location := Point(MilsToCoord(0), MilsToCoord(-600));
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '15' + ': ' + 'SPI5';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    PinArr[20].Name := 'SPI5_MISO';
    PinArr[20].OwnerPartId := 15;
    ...
    PinArr[21].Name := 'SPI5_MOSI';
    PinArr[21].OwnerPartId := 15;
    ...
    PinArr[18].Name := 'SPI5_NSS';
    PinArr[18].OwnerPartId := 15;
    PinArr[18].Location := Point(MilsToCoord(0), MilsToCoord(-300));
    ...
    PinArr[19].Name := 'SPI5_SCK';
    PinArr[19].OwnerPartId := 15;
    PinArr[19].Location := Point(MilsToCoord(0), MilsToCoord(-400));
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '16' + ': ' + 'UART4';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    PinArr[35].Name := 'UART4_RX';
    PinArr[35].OwnerPartId := 16;
    PinArr[35].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    PinArr[34].Name := 'UART4_TX';
    PinArr[34].OwnerPartId := 16;
    PinArr[34].Location := Point(MilsToCoord(0), MilsToCoord(-200));
    ...
    R.LineWidth := eSmall;
    R.Location  := Point(MilsToCoord(0), MilsToCoord(0));
    R.Corner    := Point(MilsToCoord(2000), MilsToCoord(-100*(15+1)));
    R.Color     := $000080;    // Maroon
    R.AreaColor := $B0FFFF;    // Portafino
    R.IsSolid   := True;
    R.OwnerPartId          := 17;
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '17' + ': ' + 'UNGROUPED';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    PinArr[2].Name := 'PE3';
    PinArr[2].OwnerPartId := 17;
    PinArr[2].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    PinArr[3].Name := 'PE4';
    PinArr[3].OwnerPartId := 17;
    PinArr[3].Location := Point(MilsToCoord(0), MilsToCoord(-200));
    ...
    PinArr[8].OwnerPartId := 17;
    PinArr[8].Location := Point(MilsToCoord(0), MilsToCoord(-300));
    ...
    PinArr[9].OwnerPartId := 17;
    PinArr[9].Location := Point(MilsToCoord(0), MilsToCoord(-400));
    ...
    PinArr[87].Name := 'PG2';
    PinArr[87].OwnerPartId := 17;
    PinArr[87].Location := Point(MilsToCoord(0), MilsToCoord(-500));
    ...
    PinArr[88].Name := 'PG3';
    PinArr[88].OwnerPartId := 17;
    PinArr[88].Location := Point(MilsToCoord(0), MilsToCoord(-600));
    ...
    PinArr[92].Name := 'PG7';
    PinArr[92].OwnerPartId := 17;
    PinArr[92].Location := Point(MilsToCoord(0), MilsToCoord(-700));
    ...
    PinArr[100].Name := 'PA8';
    PinArr[100].OwnerPartId := 17;
    PinArr[100].Location := Point(MilsToCoord(0), MilsToCoord(-800));
    ...
    PinArr[101].Name := 'PA9';
    PinArr[101].OwnerPartId := 17;
    PinArr[101].Location := Point(MilsToCoord(0), MilsToCoord(-900));
    ...
    PinArr[110].Name := 'PA15 (JTDI)';
    PinArr[110].OwnerPartId := 17;
    PinArr[110].Location := Point(MilsToCoord(0), MilsToCoord(-1000));
    ...
    PinArr[117].Name := 'PD3';
    PinArr[117].OwnerPartId := 17;
    PinArr[117].Location := Point(MilsToCoord(0), MilsToCoord(-1100));
    ...
    PinArr[128].OwnerPartId := 17;
    PinArr[128].Location := Point(MilsToCoord(0), MilsToCoord(-1200));
    ...
    PinArr[129].OwnerPartId := 17;
    PinArr[129].Location := Point(MilsToCoord(0), MilsToCoord(-1300));
    ...
    PinArr[134].OwnerPartId := 17;
    PinArr[134].Location := Point(MilsToCoord(0), MilsToCoord(-1400));
    ...
    PinArr[137].Name := 'PB7';
    PinArr[137].OwnerPartId := 17;
    PinArr[137].Location := Point(MilsToCoord(0), MilsToCoord(-1500));
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '18' + ': ' + 'USART2';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    PinArr[122].Name := 'USART2_RX';
    PinArr[122].OwnerPartId := 18;
    PinArr[122].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    Component.AddSchObject(R);
        ...
        // Create text object
    TextObj := SchServer.SchObjectFactory(eTextFrame, eCreate_Default);
    TextObj.Text := 'part ' + '19' + ': ' + 'USB';  // Set text content
    TextObj.Location := Point(MilsToCoord(500), MilsToCoord(0));  // 
    TextObj.Corner :=  Point(MilsToCoord(2000), MilsToCoord(100));  // 
    //TextObj.IsBorderDisplayed := True;
    TextObj.IsSolid := False; // Fill color (set via AreaColor)
    ...
    //TextObj.FontID := SchDoc.FontManager.GetFontID('Courier New', 10, False, False);
    //TextObj.Size := 10;  // Font size (points)
    TextObj.OwnerPartId   := 19;
    Component.AddSchObject(TextObj);
    

    // Add pins to this part
    // Pin '103', 'USB_OTG_FS_DM'
    PinArr[103] := SchServer.SchObjectFactory(ePin, eCreate_Default);
    If PinArr[103] = Nil Then Exit;
    PinArr[103].Designator := '103';
    PinArr[103].Name := 'USB_OTG_FS_DM';
    PinArr[103].OwnerPartId := 19;
    PinArr[103].Location := Point(MilsToCoord(0), MilsToCoord(-100));
    ...
    // Pin '104', 'USB_OTG_FS_DP'
    PinArr[104] := SchServer.SchObjectFactory(ePin, eCreate_Default);
    If PinArr[104] = Nil Then Exit;
    PinArr[104].Designator := '104';
    PinArr[104].Name := 'USB_OTG_FS_DP';
    PinArr[104].OwnerPartId := 19;
    PinArr[104].Location := Point(MilsToCoord(0), MilsToCoord(-200));
    ...
    ShowMessage('Successfully updated component with 19 functional groups');
end;
